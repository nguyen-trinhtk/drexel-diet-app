...
if __name__ == "__main__":
    try:
        scrapePage("https://drexel.campusdish.com/LocationsAndMenus/UrbanEatery", "urban.json")
    except:
        pass
    try:
        scrapePage("https://drexel.campusdish.com/LocationsAndMenus/HandschumacherDiningCenter", "hans.json")
    except:
        pass