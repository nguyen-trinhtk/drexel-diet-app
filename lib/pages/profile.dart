    ...
    return Scaffold(
        ...
        Stack(children: <Widget>[
          IgnorePointer(
              child: ThemedBox(
                  pointA: Offset(55, 30),
                  pointB: Offset(800, 325))), // Profile Box
          IgnorePointer(
              child: ThemedBox(
                  pointA: Offset(55, 350),
                  pointB: Offset(800, 760))), // User Info Box
          Positioned(
              left: 225,
              bottom: 375,
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border(
                          bottom: BorderSide(
                              width: 1.5, color: Color(0xFF232597)))),
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                SegmentedButton<Genders>(
                  ...
                  style: SegmentedButton.styleFrom(
                      ...
                      side: const BorderSide(color: Color(0xFF232597))),
                  segments: const <ButtonSegment<Genders>>[
                    ButtonSegment<Genders>(
                        value: Genders.female, label: Text('F')),
                    ButtonSegment<Genders>(
                        value: Genders.male, label: Text('M')),
                    ButtonSegment<Genders>(
                        value: Genders.nonbinary, label: Text('N/A')),
                  ],
                  selected: selection,
          ...
          Positioned(
            ...
            child: Container(
                decoration: BoxDecoration(
                    border: Border(
                        bottom: BorderSide(
                            width: 1.5, color: AppColors.primaryText))),
                child: CustomText(
                  content: "Name",
                  fontSize: 62,
                  header: true,
          ...
          Positioned(
            ...
            top: 75,
            child: CircleAvatar(
              backgroundImage: AssetImage("../assets/images/han.jpg"),
              radius: 100,
            ),
          ),
          IgnorePointer(
              child: ThemedBox(
            pointA: Offset(870, 30),
            pointB: Offset(1340, 200),
            dropShadow: true,
            pointC: Offset(878, 38),
            pointD: Offset(1348, 208),
          )),
          IgnorePointer(
              child: ThemedBox(
            pointA: Offset(870, 230),
            pointB: Offset(1340, 400),
            dropShadow: true,
            pointC: Offset(878, 238),
            pointD: Offset(1348, 408),
          )),
          IgnorePointer(
              child: ThemedBox(
            pointA: Offset(870, 430),
            pointB: Offset(1340, 600),
            dropShadow: true,
            pointC: Offset(878, 438),
